...
export default function VendorSecurityPage() {
  ...
  return (
    <main className="min-h-full bg-[#faf8f6]"> <div className="mx-auto max-w-full px-4 py-6 sm:px-6 sm:py-8 lg:px-8 lg:py-10">
      {/* Header */}
      ...
      <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_330px] lg:items-start">
        ...
        <section className=" border border-[#ebe3dd] bg-white p-5 shadow-[0_12px_40px_rgba(62,45,36,0.045)] sm:p-7 lg:p-8">
          ...
          >
                ...
                <div className="mt-3 flex flex-wrap gap-x-4 gap-y-2">
                  {REQUIREMENTS.map((item) => {
                    ...
                    return (
                      <div
                        key={item.key}
                        className={`flex items-center gap-1.5 text-[11px] ${fulfilled
                          ? "text-[#66806f]"
                          : "text-[#948982]"
                          }`}
                      >
            ...
            {confirmPassword.length > 0 && (
              <div
                className={`-mt-2 flex items-center gap-1.5 text-[11px] ${passwordsMatch
                  ? "text-[#63806d]"
                  : "text-[#b86565]"
                  }`}
              >
