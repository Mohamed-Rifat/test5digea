...
export default function RoadmapPage() { return <AuthGuard><main className="min-h-screen bg-[#faf8f6]"><SiteNavbar/><RoadmapContent/></main></AuthGuard>; }
